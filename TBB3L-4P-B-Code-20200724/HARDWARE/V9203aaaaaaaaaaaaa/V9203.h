...
#define DATAPC       0xE8EA // c相全波平均有功功率寄存器 
...
//#define ms 1
//#define s  2
//#define second(UNIT, MULTIPLE, X)        UNIT == ms ? X * 1000 / (UNIT * MULTIPLE) : X
//#define minuter(UNIT, MULTIPLE,X)        UNIT == ms ? 60 * X * 1000 / (UNIT * MULTIPLE) : 60 * X
//#define hour(UNIT, MULTIPLE,X)           UNIT == ms ? 3600* X * 1000 / (UNIT * MULTIPLE) : 3600 * X
...
}EnergyCountValueBuffer;
	
extern V9203_TypeDef gV9203_Info;
extern void V9203_GPIO_Init(void);
